...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#23262F] flex flex-col justify-between">
      ...
      {/* Splash Content */}
      <main className="flex-1 flex flex-col items-center justify-center px-8 py-16 max-w-3xl mx-auto w-full">
        <h1 className="text-5xl font-extrabold text-white mb-2 text-center">We U</h1>
        <h2 className="text-3xl font-bold text-white mb-4 text-center">Pay with stablecoins.</h2>
        <p className="text-lg text-gray-300 mb-6 text-center">Use your stablecoins on <span className="text-[#176B63] font-semibold">everyday</span> transactions.</p>
        ...
        <a href="#" className="mb-8 block mx-auto">
        ...
        <Link href="/signup" className="bg-[#F0B90B] text-[#176B63] font-bold px-8 py-3 rounded-lg text-lg shadow hover:bg-[#e6a800] transition mx-auto">Sign Up</Link>
      </main>
