    ...
    <div className="min-h-screen bg-[#23262F] flex flex-col">
      ...
      <header className="bg-[#176B63] py-4 px-8 flex items-center justify-between">
        <div className="flex items-center gap-2">
          {/* Logo Placeholder */}
          <div className="w-10 h-10 bg-[#F0B90B] rounded-full flex items-center justify-center text-2xl font-bold text-[#176B63]">T</div>
        </div>
      ...
      {/* Splash Content */}
      <main className="flex-1 flex flex-col md:flex-row items-center justify-between px-8 py-16 max-w-7xl mx-auto w-full">
        {/* Left: Info */}
        ...
        <div className="flex-1 flex items-center justify-center mt-12 md:mt-0">
          <img src="/phone-mockup.png" alt="App phone mockup" className="max-w-xs w-full rounded-2xl shadow-2xl border-4 border-[#176B63] bg-white" />
        </div>
      </main>
    </div>
  );
