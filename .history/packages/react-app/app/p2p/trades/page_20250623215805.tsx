...
const trades = [
  { id: "TRD-001", type: "Trade", status: "Open" },
  { id: "TRD-002", type: "Trade", status: "Completed" },
  { id: "TRD-003", type: "Trade", status: "Cancelled" },
];
...
export default function TradesPage() {
  ...
  const filteredTrades = effectiveCountry !== 'US'
    ? trades.filter(item => (effectiveCountry === 'Nigeria' && item.id.endsWith('1')) || (effectiveCountry === 'Ghana' && item.id.endsWith('2')))
    : trades;
