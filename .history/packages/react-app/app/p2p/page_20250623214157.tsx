...
export default function Dashboard() {
  ...
  const filteredRecent = location && location.country !== 'US'
    ? mockRecent.filter(item => (location.country === 'Nigeria' && item.id.endsWith('1')) || (location.country === 'Ghana' && item.id.endsWith('2')))
    : mockRecent;
